...
// Infer missing `type: "object"` when an object has `properties` but no
// declared type. Gemini/Antigravity reject schemas where `properties` exists
// without an explicit `type=object`, so this normalises them in place.
