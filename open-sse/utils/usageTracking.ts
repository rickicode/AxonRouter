	...
	// Claude format (message_delta event)
		if (
			...
			return normalizeUsage({
				...
				prompt_tokens_details: Number.isFinite(Number(cacheReadTokens))
					? { cached_tokens: Number(cacheReadTokens) }
					: undefined,
				completion_tokens_details: Number.isFinite(Number(reasoningTokens))
