...
export async function handleEmbeddingsCore({
  ...
  if (typeof input !== "string" && !Array.isArray(input)) {
    return createErrorResult(HTTP_STATUS.BAD_REQUEST, "input must be a string or array of strings", null);
  }
  ...
  if (!providerResponse.ok) {
    ...
    return createErrorResult(statusCode, errMsg, null);
  }
  ...
  try {
    ...
    return createErrorResult(HTTP_STATUS.BAD_GATEWAY, `Invalid JSON response from ${provider}`, null);
  }
