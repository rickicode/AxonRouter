 ...
 * into axonrouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are axonrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic axonrouter variant set for a single upstream Kiro model.
 *
 ...
 * into axonrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
