export default {
  ...
  models: [
    ...
    { id: "deepseek-v3", name: "DeepSeek V3", strip: ["image","audio"] },
    { id: "deepseek-r1", name: "DeepSeek R1", strip: ["image","audio"] },
    { id: "qwen3-235b", name: "Qwen3 235B", strip: ["image","audio"] },
    ...
    { id: "claude-haiku-4.6-thinking", name: "Claude Haiku 4.6 (Thinking)" },
    ...
    { id: "claude-haiku-4.6-agentic", name: "Claude Haiku 4.6 (Agentic)" },
    ...
    { id: "claude-haiku-4.6-thinking-agentic", name: "Claude Haiku 4.6 (Thinking + Agentic)" },
