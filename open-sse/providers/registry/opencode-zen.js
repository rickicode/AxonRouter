export default {
  ...
  models: [
    ...
    // Claude models (Anthropic /messages endpoint)
    { id: "claude-fable-5-1", name: "Claude Fable 5.1", supportedFormats: ["openai", "claude"] },
    { id: "claude-fable-5", name: "Claude Fable 5", supportedFormats: ["openai", "claude"] },
    { id: "claude-opus-5", name: "Claude Opus 5", supportedFormats: ["openai", "claude"] },
    { id: "claude-opus-4-8", name: "Claude Opus 4.8", supportedFormats: ["openai", "claude"] },
    { id: "claude-opus-4-7", name: "Claude Opus 4.7", supportedFormats: ["openai", "claude"] },
    { id: "claude-opus-4-6", name: "Claude Opus 4.6", supportedFormats: ["openai", "claude"] },
    { id: "claude-opus-4-5", name: "Claude Opus 4.5", supportedFormats: ["openai", "claude"] },
    { id: "claude-sonnet-5", name: "Claude Sonnet 5", supportedFormats: ["openai", "claude"] },
    { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", supportedFormats: ["openai", "claude"] },
    { id: "claude-sonnet-4-5", name: "Claude Sonnet 4.5", supportedFormats: ["openai", "claude"] },
    { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", supportedFormats: ["openai", "claude"] },
    ...
    { id: "deepseek-v4-flash-free", name: "DeepSeek V4 Flash Free", supportedFormats: ["openai", "claude", "openai-responses"] },
