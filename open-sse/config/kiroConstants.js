 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what axonrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a axonrouter
 ...
 * The suffix is a axonrouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a axonrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a axonrouter synthetic thinking variant
...
/**
 * Resolve a axonrouter model id to the real upstream Kiro model id, plus flags
