...
export async function initializeApp() {
  try {
    ...
    // Auto-reconnect cloudflared tunnel if it was enabled before restart
    ...
    // Cloudflared binary will be auto-downloaded on first start if needed
