...
export const APIKEY_PROVIDERS = {
  ...
  "opencode-go": { id: "opencode-go", alias: "ocg", name: "OpenCode Go", icon: "terminal", color: "#E87040", textIcon: "OC", website: "https://opencode.ai/auth", notice: { text: "OpenCode Go subscription: /mo (then 0/mo). Access to Kimi, GLM, Qwen, MiMo, MiniMax models.", apiKeyUrl: "https://opencode.ai/auth" }, apiKeyCompatible: true },
  "opencode-zen": { id: "opencode-zen", alias: "ocz", name: "OpenCode Zen", icon: "terminal", color: "#E87040", textIcon: "OC", website: "https://opencode.ai/auth", passthroughModels: true, notice: { text: "OpenCode Zen: full access to all 43+ models (Claude, GPT, Gemini, etc.) with API key.", apiKeyUrl: "https://opencode.ai/auth" }, apiKeyCompatible: true },
  "opencode-provider": { id: "opencode-provider", alias: "ocp", name: "OpenCode Provider", icon: "terminal", color: "#E87040", textIcon: "OP", website: "https://opencode.ai/auth", apiKeyCompatible: true, notice: { text: "OpenCode Provider: base paid tier with access to core models (GLM, Kimi, Qwen, MiMo, MiniMax).", apiKeyUrl: "https://opencode.ai/auth" } },
