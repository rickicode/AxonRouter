...
export const MODEL_PRICING = {
  ...
  // === Gemini ===
  "gemini-3.5-pro-high":          { input: 4.00,  output: 18.00, cached: 0.50,  reasoning: 27.00,  cache_creation: 4.00  },
  "gemini-3.5-pro-low":           { input: 2.00,  output: 12.00, cached: 0.25,  reasoning: 18.00,  cache_creation: 2.00  },
  ...
  "morph-qwen35-397b":            { input: 0.478, output: 3.50,  cached: 0.00,  reasoning: 3.50,   cache_creation: 0.00  },
  "morph/morph-qwen35-397b":      { input: 0.478, output: 3.50,  cached: 0.00,  reasoning: 3.50,   cache_creation: 0.00  },
  "morph-qwen36-27b":             { input: 0.498, output: 2.40,  cached: 0.00,  reasoning: 2.40,   cache_creation: 0.00  },
  "morph/morph-qwen36-27b":       { input: 0.498, output: 2.40,  cached: 0.00,  reasoning: 2.40,   cache_creation: 0.00  },
  ...
  "morph-dsv4flash":              { input: 0.30,  output: 0.40,  cached: 0.00,  reasoning: 0.40,   cache_creation: 0.00  },
  "morph/morph-dsv4flash":        { input: 0.30,  output: 0.40,  cached: 0.00,  reasoning: 0.40,   cache_creation: 0.00  },
  ...
  "MiniMax-M2.7":                 { input: 0.279, output: 1.20,  cached: 0.00,  reasoning: 1.20,   cache_creation: 0.00  },
  "minimax-m2.1":                 { input: 0.50,  output: 2.00,  cached: 0.25,  reasoning: 3.00,   cache_creation: 0.50  },
  "minimax-m2.5":                 { input: 0.60,  output: 2.40,  cached: 0.30,  reasoning: 3.60,   cache_creation: 0.60  },
  "morph-minimax27-230b":         { input: 0.279, output: 1.20,  cached: 0.00,  reasoning: 1.20,   cache_creation: 0.00  },
  "morph/morph-minimax27-230b":   { input: 0.279, output: 1.20,  cached: 0.00,  reasoning: 1.20,   cache_creation: 0.00  },
...
/**
 * Provider-specific pricing entries.
...
export const PATTERN_PRICING = [
  ...
  { pattern: "gemini-3.5-*",      pricing: { input: 0.50,  output: 3.00,  cached: 0.03,  reasoning: 4.50,   cache_creation: 0.50  } },
