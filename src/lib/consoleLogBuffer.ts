...
// Filter out Next.js dev/build noise that pollutes the dashboard console
const NOISE_RE = /\[browser\]|\[server\]|✓ Compiled|○ Compiling|Parsing ecmascript|Import trace:|Expected '<\/|got 'jsx text'|Server Component:/;
