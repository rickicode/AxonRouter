...
export function ProviderStatusBadge({ children, tone = "default", showDot = false }) {
  return (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold flex items-center gap-1.5">
                  {provider.name}
                  {provider.hasFree && (
                    <ShadcnBadge variant="outline" className="border-[var(--color-success)]/35 bg-[var(--color-success)]/14 text-[var(--color-success)] text-[10px] px-1.5 py-0">
                      Free
                    </ShadcnBadge>
                  )}
                </h3>
