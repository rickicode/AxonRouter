...
export default function ProfilePage() {
 ...
 samlIssuer: data?.samlIssuer || "urn:axonrouter:sp",
 ...
 samlIssuer: prev.samlIssuer || "urn:axonrouter:sp",
 ...
 samlIssuer: samlForm.samlIssuer.trim() || "urn:axonrouter:sp",
 ...
 headers: { "x-axonrouter-password": password },
 });
 if (!res.ok) {
 const data = await res.json().catch(() => ({}));
...
/>
 ...
 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-sm bg-bg border border-border gap-2">
 <div>
 <p className="font-medium text-sm">Database Engine</p>
 <p className="text-xs sm:text-sm text-text-muted font-mono break-all">PostgreSQL Engine (AxonRouter-X High Performance)</p>
 </div>
 </div>
 ...
 {memoryInfo && (
 <pre className="text-[11px] font-mono text-text-muted whitespace-pre-wrap break-all rounded-sm border border-border bg-surface p-3 text-xs text-text-main">
 {memoryInfo.error
...
className="flex items-center justify-between w-full p-3 rounded-sm bg-bg border border-border hover:border-primary/30 min-h-11 sm:h-8 sm:min-h-0"
 ...
 Protects dashboard web UI. When ON, accessing settings and management pages requires password/OIDC authentication. Does not affect model API key verification.
 </p>
 </div>
 <Toggle
 ...
 <form onSubmit={handlePasswordChange} className="flex flex-col gap-3 pt-3 border-t border-border">
 {settings.hasPassword && (
 <div className="flex flex-col gap-2">
 <label className="text-xs sm: font-medium text-text-muted">Current Password</label>
 <Input
 type="password"
...
Setting password for the first time. Leave current password empty or use default: <code className="bg-primary/10 px-1 rounded-sm">12345677</code>
 ...
 <div className="flex flex-col gap-2">
 <label className="text-xs sm: font-medium text-text-muted">New Password</label>
 <Input
 type="password"
 ...
 <div className="flex flex-col gap-2">
 <label className="text-xs sm: font-medium text-text-muted">Confirm New Password</label>
 <Input
 type="password"
...
<Icon name={oidcExpanded ? "expand_less" : "expand_more"} className="text-text-muted shrink-0" />
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">SSO Protocol</label>
 <div className="flex size-8 rounded-sm bg-surface border border-border">
 <button
 type="button"
 onClick={() => setSsoTypeTab("saml")}
 className={cn(
 "flex-1 py-2 px-3 rounded-sm font-medium text-xs sm:text-sm text-center",
 ssoTypeTab === "saml"
 ? "bg-surface text-text-main "
 : "text-text-muted hover:text-text-main"
 )}
 ...
 {/* Auth Mode selection */}
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Auth Mode</label>
 ...
 className={cn(
 "text-left rounded-sm border p-3",
 active
 ...
 <div className="rounded-sm border border-border bg-bg/80 overflow-hidden">
 <button
 type="button"
 ...
 {showSamlGuide && (
 <div className="p-3 border-t border-border bg-surface/30 text-xs text-text-main flex flex-col gap-3">
 <div className="p-3 rounded-sm border border-primary/30 bg-primary/10 text-primary text-xs">
 <p className="font-medium mb-1">🔑 Required Service Provider (SP) Values for your IdP Setup:</p>
 <ul className="list-disc pl-3 space-y-3 font-mono text-[11px]">
 <li>
 <b>Assertion Consumer Service (ACS) URL:</b>{" "}
 <code className="bg-bg px-1 py-1 rounded-sm break-all">{samlAcsUrl}</code>
 </li>
 <li>
 <b>SP Entity ID / Audience URI:</b>{" "}
 <code className="bg-bg px-1 py-1 rounded-sm break-all">{samlForm.samlIssuer || "urn:axonrouter:sp"}</code>
 </li>
 <li>
 <b>NameID Format:</b>{" "}
 <code className="bg-bg px-1 py-1 rounded-sm">EmailAddress</code> or <code className="bg-bg px-1 py-1 rounded-sm">Unspecified</code>
 </li>
 </ul>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
 <div className="p-3 rounded-sm border border-border bg-bg/50 flex flex-col gap-1.5">
 <p className="font-medium text-text-main flex items-center gap-1.5">
 <span>☁️</span> AWS IAM Identity Center
 </p>
 <ol className="list-decimal pl-3 text-text-muted space-y-3">
 ...
 <li>Set <b>Application SAML audience</b> to <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:axonrouter:sp"}</code>.</li>
 ...
 <li><b>Identifier (Entity ID):</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:axonrouter:sp"}</code></li>
 ...
 <li><b>Audience URI (SP Entity ID):</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:axonrouter:sp"}</code></li>
 ...
 <li><b>Client ID:</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:axonrouter:sp"}</code></li>
 ...
 {/* Quick Import Card */}
 <div className="p-3 rounded-sm border border-dashed border-primary/30 bg-primary/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
 <div>
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Single Sign-On Service URL (samlEntryPoint)</label>
 <Input
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">SP Entity ID / Audience (samlIssuer)</label>
 <Input
 placeholder="urn:axonrouter:sp"
 ...
 <label className="font-medium text-xs text-text-muted">IdP X.509 Certificate (samlCert)</label>
 <Button
 type="button"
 variant="outline"
 size="sm"
 ...
 className="w-full p-3 rounded-sm border border-border bg-surface text-xs font-mono text-text-main focus:outline-none focus:border-primary"
 disabled={loading || samlLoading}
 />
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Login Button Label</label>
 <Input
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Email Claim Attribute</label>
 <Input
 placeholder="email"
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Display Name Claim</label>
 <Input
 placeholder="name"
 ...
 <div className="flex flex-col gap-2 p-3 rounded-sm border border-border bg-bg text-xs sm:text-sm text-text-muted">
 ...
 <div className="flex items-center justify-between gap-2 pt-2 border-t border-border h-8">
 <div>
 ...
 <div className="grid grid-cols-1 gap-3">
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Issuer URL</label>
 <Input
 placeholder="https://auth.example.com/application/o/axonrouter/"
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Client ID</label>
 <Input
 placeholder="axonrouter-dashboard"
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Client Secret</label>
 <Input
 type="password"
 ...
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Scopes</label>
 <Input
 ...
 <div className="rounded-sm border border-border bg-bg p-3 text-xs sm:text-sm text-text-muted">
 ...
 <form onSubmit={updateOutboundProxy} className="flex flex-col gap-3 pt-2 border-t border-border">
 <div className="flex flex-col gap-2">
 <label className="font-medium text-xs text-text-muted">Proxy URL</label>
 <Input
 ...
 <label className="font-medium text-xs text-text-muted">No Proxy</label>
 <Input
 ...
 {proxyStatus.message && (
 <p className={`text-xs sm:text-sm ${proxyStatus.type === "error" ? "text-danger" : "text-success"} pt-2 border-t border-border`}>
 {proxyStatus.message}
 </p>
 )}
 </div>
 ...
 {/* App Info */}
 <div className="text-center text-xs sm:text-sm text-text-muted py-3">
 <p>{APP_CONFIG.name} v{APP_CONFIG.version}</p>
 <p className="mt-1">{isRemoteHost ? "Remote Mode" : "Local Mode - All data stored on your machine"}</p>
 <a
 href="https://github.com/rickicode/axonrouter-X"
 target="_blank"
 rel="noreferrer"
