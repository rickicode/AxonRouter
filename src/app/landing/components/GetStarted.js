        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install AxonRouter, configure your providers via web dashboard, and start routing AI requests.
            </p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg">Install AxonRouter</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Point your CLI tools to http://localhost:3777</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("npx axonrouter")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">npx axonrouter</span>
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#f97815]">&gt;</span> Starting AxonRouter...<br/>
                  <span className="text-[#f97815]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:3777</span><br/>
                  <span className="text-[#f97815]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:3777/dashboard</span><br/>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  PostgreSQL:</span> postgres://user:pass@localhost:5432/axonrouter<br/>
