        ...
        <section className="py-32 px-6 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              Join developers who are streamlining their AI integrations with AxonRouter. Open source and free to start.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button 
                onClick={() => router.push("/dashboard")}
                className="h-14 w-full rounded-[4px] bg-[#f97815] px-10 text-lg font-bold text-[#181411] shadow-[0_0_20px_rgba(249,120,21,0.5)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-[#ff8d38] sm:w-auto"
              >
                Start Free
              </Button>
              <Button 
                variant="outline"
                onClick={() => window.open("https://github.com/rickicode/axonrouter#readme", "_blank")}
                className="h-14 w-full rounded-[4px] border-[#3a2f27] bg-transparent px-10 text-lg font-bold text-white transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-[#23180f] hover:text-white sm:w-auto"
              >
                Read Documentation
              </Button>
            </div>
