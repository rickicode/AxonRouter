<div align="center">
  <img src="./images/axonrouter.png?1" alt="داشبورد AxonRouter" width="800"/>
  
  # AxonRouter - مسیریاب رایگان هوش مصنوعی و ذخیره‌ساز توکن
...
[🚀 شروع سریع](#-شروع-سریع) • [💡 ویژگی‌ها](#-ویژگی‌های-کلیدی) • [📖 راه‌اندازی](#-راهنمای-راه‌اندازی) • [🌐 وب‌سایت](https://axonrouter.com)
...
**AxonRouter این مشکلات را حل می‌کند:**
...
بسته این مخزن خصوصی است (`axonrouter-app`)، بنابراین اجرا از سورس/داکر مسیر معمول توسعه محلی است.
...
<table>
  ...
  <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
    <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="صرفه‌جویی در هزینه LLM با AxonRouter" width="300"/>
  </a><br/>
  <b>🇻🇳 ویتنامی</b><br/>
  <sub>صرفه‌جویی در هزینه LLM برای OpenClaw با AxonRouter<br/>توسط <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="راه‌اندازی نامحدود رایگان AxonRouter + Claude Code" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>راه‌اندازی نامحدود رایگان AxonRouter + Claude Code<br/>توسط <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="آموزش راه‌اندازی AxonRouter" width="300"/>
      </a><br/>
      <b>🇺🇸 انگلیسی</b><br/>
      <sub>راه‌اندازی رایگان AxonRouter + Claude Code<br/>توسط <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="آموزش راه‌اندازی AxonRouter" width="300"/>
      </a><br/>
      <b>🇺🇸 انگلیسی</b><br/>
      <sub>راه‌اندازی رایگان AxonRouter + Claude Code<br/>توسط <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 انگلیسی</b><br/>
      <sub>راه‌اندازی رایگان Claude CLI با AxonRouter 🚀<br/>توسط <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 ویتنامی</b><br/>
      <sub>نصب کامل OpenClaw رایگان از صفر تا صد + AxonRouter<br/>توسط <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 اندونزیایی</b><br/>
      <sub>کدنویسی ۲۴ ساعته بدون محدودیت نرخ! صرفه‌جویی ۶۵٪ توکن هوش مصنوعی | آموزش راه‌اندازی سریع AxonRouter 🚀<br/>توسط <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="روش استقرار AxonRouter در Hugging Face رایگان و همیشه روشن! | جایگزین VPS با ۱۶ گیگابایت رم" width="300"/>
      </a><br/>
      <b>🇮🇩 اندونزیایی</b><br/>
      <sub>روش استقرار AxonRouter در Hugging Face رایگان و همیشه روشن! | جایگزین VPS با ۱۶ گیگابایت رم<br/>توسط <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **درباره AxonRouter ویدیو ساخته‌اید؟** یک [درخواست Pull](https://github.com/decolua/axonrouter/pulls) برای افزودن ویدیوی خود به این بخش ارسال کنید — ما آن را ادغام خواهیم کرد!

---

## 🛠️ ابزارهای خط فرمان پشتیبانی شده

AxonRouter به‌طور یکپارچه با تمام ابزارهای اصلی کدنویسی هوش مصنوعی کار می‌کند:
...
Headroom اختیاری است و به‌طور جداگانه اجرا می‌شود. AxonRouter نقطه پایانی محلی `/v1/compress` Headroom را فراخوانی کرده، سپس مسیریابی معمولی، بازگشت، احراز هویت و پیگیری مصرف را ادامه می‌دهد:

```
کلاینت → AxonRouter → Headroom /v1/compress → AxonRouter → ارائه‌دهنده
```
...
اگر Headroom از کار بیفتد یا خطا برگرداند، AxonRouter به‌حالت بازگشت باز می‌شود و درخواست اصلی را ارسال می‌کند.
...
- ابزار خط فرمان شما قالب OpenAI ارسال می‌کند → AxonRouter ترجمه می‌کند → ارائه‌دهنده قالب بومی دریافت می‌کند
...
> خود AxonRouter **هرگز از شما هزینه‌ای دریافت نمی‌کند**. شما فقط مستقیماً به ارائه‌دهندگان هزینه می‌پردازید (در صورت استفاده از خدمات پولی).
>
...
>
> به آن به عنوان "ردیاب پس‌انداز" فکر کنید که نشان می‌دهد با استفاده از مدل‌های رایگان یا مسیریابی از طریق AxonRouter چقدر صرفه‌جویی می‌کنید!
...
### 📊 درک هزینه‌ها و صورتحساب AxonRouter

**واقعیت صورتحساب AxonRouter:**

✅ **نرم‌افزار AxonRouter = رایگان برای همیشه** (منبع باز، هرگز هزینه‌ای دریافت نمی‌کند)  
...
❌ **AxonRouter هرگز صورتحساب ارسال نمی‌کند** یا کارت شما را شارژ نمی‌کند
...
- **ارائه‌دهندگان ارزان** (GLM، MiniMax): مستقیماً به آنها پرداخت کنید، AxonRouter فقط مسیریابی می‌کند
- **ارائه‌دهندگان رایگان** (iFlow، Kiro، Qwen): واقعاً برای همیشه رایگان، بدون هزینه پنهان
- **AxonRouter**: هرگز هیچ هزینه‌ای دریافت نمی‌کند، همیشه
...
داشبورد مصرف توکن شما را پیگیری کرده و **هزینه‌های تخمینی** را نشان می‌دهد گویی مستقیماً از APIهای پولی استفاده می‌کنید. این **صورتحساب واقعی نیست** - این یک مرجع برای نشان دادن میزان پس‌انداز شما با استفاده از مدل‌های رایگان یا اشتراک‌های موجود از طریق AxonRouter است.
...
<details>
<summary><b>💳 آیا توسط AxonRouter شارژ می‌شوم؟</b></summary>

**خیر.** AxonRouter نرم‌افزاری رایگان و منبع باز است که روی رایانه خودتان اجرا می‌شود. هرگز از شما هزینه‌ای دریافت نمی‌کند.
...
- ✅ **ارائه‌دهندگان ارزان** (GLM، MiniMax) → مستقیماً به آنها پرداخت کنید، AxonRouter فقط درخواست‌های شما را مسیریابی می‌کند
- ❌ **خود AxonRouter** → **هرگز هیچ هزینه‌ای دریافت نمی‌کند، همیشه**

AxonRouter یک پروکسی/مسیریاب محلی است. کارت اعتباری شما را ندارد، نمی‌تواند صورتحساب ارسال کند و سیستم صورتحساب ندارد. این نرم‌افزار کاملاً رایگان است.
...
AxonRouter فقط درخواست‌های شما را به آنها مسیریابی می‌کند - هیچ "دام" یا صورتحساب آینده‌ای وجود ندارد. آنها واقعاً خدمات رایگان هستند و AxonRouter استفاده از آنها را با پشتیبانی از بازگشت آسان می‌کند.
...
۳. **از ارائه‌دهندگان اشتراک در آخر استفاده کنید:**
   ...
   - AxonRouter با پیگیری سهمیه به حداکثر رساندن ارزش آنها کمک می‌کند
...
بازگشت هوشمند AxonRouter از هزینه‌های غافلگیرکننده جلوگیری می‌کند:
...
**شما کنترل دارید:** محدودیت‌های هزینه را برای هر ارائه‌دهنده در داشبورد تنظیم کنید و AxonRouter به آنها احترام می‌گذارد.
...
**نکته حرفه‌ای:** از Opus برای کارهای پیچیده و Sonnet برای سرعت استفاده کنید. AxonRouter سهمیه را به ازای هر مدل پیگیری می‌کند!
...
تنظیمات → مدل‌ها → پیشرفته:
  ...
  کلید API OpenAI: [از داشبورد axonrouter]
...
> **توجه:** OpenClaw فقط با AxonRouter محلی کار می‌کند. برای جلوگیری از مشکلات وضوح IPv6 از `127.0.0.1` به جای `localhost` استفاده کنید.
...
docker pull decolua/axonrouter:latest   # به‌روزرسانی به آخرین نسخه
```

**ماندگاری داده:** `$HOME/.axonrouter/db/data.sqlite` در میزبان ↔ `/app/data/db/data.sqlite` در کانتینر.

### متغیرهای محیطی

| متغیر                                             | پیش‌فرض                                  | توضیحات                                                                         |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET`                                         | تولید خودکار (`~/.axonrouter/jwt-secret`) | راز امضای JWT برای کوکی احراز هویت داشبورد (برای اشتراک بین نمونه‌ها بازنویسی کنید)   |
| `INITIAL_PASSWORD`                                   | `123456`                                 | رمز عبور اولین ورود در صورت عدم وجود هش ذخیره شده                                      |
| `DATA_DIR`                                           | `~/.axonrouter`                             | مکان اصلی داده‌های برنامه (SQLite در `$DATA_DIR/db/data.sqlite`)                       |
...
| `CLOUD_URL`                                          | `https://axonrouter.com`                    | آدرس پایه نقطه پایانی همگام‌سازی ابری سمت سرور                                            |
| `NEXT_PUBLIC_BASE_URL`                               | `http://localhost:3000`                  | آدرس پایه عمومی/سازگار با گذشته (برای زمان اجرای سرور `BASE_URL` را ترجیح دهید)          |
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://axonrouter.com`                    | آدرس ابری عمومی/سازگار با گذشته (برای زمان اجرای سرور `CLOUD_URL` را ترجیح دهید)        |
...
- هر دو `${DATA_DIR}` و `~/.axonrouter` در یک کانتینر داکر به یک مکان اشاره می‌کنند — symlink `/root/.axonrouter -> /app/data` در زمان ساخت ایجاد می‌شود.
...
- توسط AxonRouter به‌طور خودکار بازسازی می‌شود
...
- **وب‌سایت**: [axonrouter.com](https://axonrouter.com)
- **GitHub**: [github.com/decolua/axonrouter](https://github.com/decolua/axonrouter)
- **مسائل**: [github.com/decolua/axonrouter/issues](https://github.com/decolua/axonrouter/issues)

---

## 👥 مشارکت‌کنندگان

با تشکر از همه مشارکت‌کنندگانی که به بهتر شدن AxonRouter کمک کردند!
...
**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — یک فورک کامل TypeScript از AxonRouter. بیش از ۳۶ ارائه‌دهنده، بازگشت خودکار ۴ لایه، APIهای چندوجهی (تصاویر، جاسازی‌ها، صدا، TTS)، قطع‌کننده مدار، حافظه پنهان معنایی، ارزیابی‌های LLM و داشبوردی زیبا اضافه می‌کند. بیش از ۳۶۸ تست واحد. از طریق npm و داکر در دسترس است.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — ذخیره‌ساز توکن Rust. AxonRouter خط لوله فشرده‌سازی آن را به JS منتقل می‌کند → **۲۰-۴۰٪- توکن ورودی** در هر درخواست.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) توسط **[@JuliusBrussee](https://github.com/JuliusBrussee)** — پرامپت ویروسی _"چرا از توکن زیاد استفاده کنی وقتی توکن کم کار را انجام می‌دهد"_. AxonRouter پرامپت آن را تطبیق می‌دهد → **۶۵٪- توکن خروجی**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) توسط **[@DietrichGebert](https://github.com/DietrichGebert)** — مهارت _"توسعه‌دهنده ارشد تنبل"_. AxonRouter نردبان YAGNI-first آن را تزریق می‌کند → **توکن کمتر، کد کمتر، دیف‌های کوتاه‌تر**.

تشکر فراوان از این نویسندگان — بدون کار آنها، ویژگی‌های ذخیره‌سازی توکن AxonRouter وجود نداشت. ⭐ آنها را در GitHub بدهید!
