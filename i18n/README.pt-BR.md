<div align="center">
  <img src="../images/axonrouter.png?1" alt="Painel do AxonRouter" width="800"/>
  
  # AxonRouter — roteador de IA GRATUITO e economizador de tokens
  ...
  **Conecte todas as ferramentas de código de IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a mais de 40 provedores de IA e mais de 100 modelos.**
  ...
  [![Licença](https://img.shields.io/npm/l/axonrouter.svg)](https://github.com/decolua/axonrouter/blob/main/LICENSE)
...
[🚀 Início rápido](#-início-rápido) • [💡 Recursos](#-principais-recursos) • [📖 Configuração](#-guia-de-configuração) • [🌐 Site](https://axonrouter.com)
...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           AxonRouter (Roteador inteligente)            │
...
Este pacote de repositório é privado (`axonrouter-app`), portanto, a execução pelo código-fonte/Docker é o caminho de desenvolvimento local esperado.
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no AxonRouter<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>AxonRouter + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
      ...
      <b>🇺🇸 Inglês</b><br/>
      <sub>AxonRouter + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com AxonRouter 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + AxonRouter<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida AxonRouter 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante AxonRouter no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=hPusYX-5Pmw">
        <img src="https://img.youtube.com/vi/hPusYX-5Pmw/maxresdefault.jpg" alt="Hướng Dẫn Setup OpenClaw + AxonRouter: Tạo Bot Zalo AI Tự Động Từ A-Z" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + AxonRouter: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
> 🎬 **Fez um vídeo sobre o AxonRouter?** Envie um [Pull Request](https://github.com/decolua/axonrouter/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!

---

## 🛠️ Ferramentas CLI suportadas

AxonRouter funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
Configure `X-AxonRouter-Token-Saver: off` para ignorar todos os economizadores de tokens para uma solicitação de chat.
...
O headroom é opcional e funciona separadamente. AxonRouter chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → AxonRouter → Headroom /v1/compress → AxonRouter → provedor
```
...
Se o Headroom estiver inativo ou retornar um erro, o o AxonRouter seguirá em modo aberto e enviará a solicitação original.
...
- Sua ferramenta CLI envia formato OpenAI → AxonRouter traduz → Provedor recebe formato nativo
...
> O próprio AxonRouter **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do AxonRouter!
...
### 📊 Compreendendo os custos e faturamento do AxonRouter

**Como funciona o faturamento do AxonRouter:**

✅ **Software AxonRouter = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **AxonRouter nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, AxonRouter apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **AxonRouter**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do AxonRouter.
...
<details>
<summary><b>💳 Serei cobrado pelo AxonRouter?</b></summary>

**Não.** AxonRouter é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, AxonRouter apenas encaminha suas solicitações
- ❌ **AxonRouter em si** → **Nunca carrega nada, nunca**

AxonRouter é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O AxonRouter apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio AxonRouter. Eles são serviços verdadeiramente gratuitos e o AxonRouter os torna fáceis de usar com suporte alternativo.
...
- AxonRouter ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do AxonRouter evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o AxonRouter os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. AxonRouter rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do AxonRouter]
...
> **Nota:** OpenClaw só funciona com AxonRouter local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
- Hub Docker: [`decolua/axonrouter`](https://hub.docker.com/r/decolua/axonrouter)
...
docker pull decolua/axonrouter:latest   # atualizar para a versão mais recente
```

**Persistência de dados:** `$HOME/.axonrouter/db/data.sqlite` no host ↔ `/app/data/db/data.sqlite` no contêiner.

### Variáveis de Ambiente

| Variável | Padrão | Descrição |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET` | Gerado automaticamente (`~/.axonrouter/jwt-secret`) | Segredo de assinatura JWT para cookie de autenticação do painel (substituir para compartilhar entre instâncias) |
| `INITIAL_PASSWORD` | `123456` | Primeira senha de login quando não existe hash salvo |
| `DATA_DIR` | `~/.axonrouter` | Localização principal dos dados do aplicativo (SQLite em `$DATA_DIR/db/data.sqlite`) |
...
| `CLOUD_URL` | `https://axonrouter.com` | URL base do endpoint de sincronização na nuvem do lado do servidor |
...
| `NEXT_PUBLIC_CLOUD_URL` | `https://axonrouter.com` | URL de nuvem pública/compatível com versões anteriores (prefira `CLOUD_URL` para tempo de execução do servidor) |
...
- `${DATA_DIR}` e `~/.axonrouter` resolvem para o mesmo local em um contêiner Docker — o link simbólico `/root/.axonrouter -> /app/data` é criado no momento da construção.
...
- Atualizado automaticamente pelo AxonRouter
...
- **Site**: [axonrouter.com](https://axonrouter.com)
...
Obrigado a todos os colaboradores que ajudaram a tornar o AxonRouter melhor!

[![Contribuidores](https://contrib.rocks/image?repo=decolua/axonrouter&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/axonrouter/graphs/contributors)

---

## 📊 Gráfico de estrelas

[![Gráfico de estrelas](https://starchart.cc/decolua/axonrouter.svg?variant=adaptive)](https://starchart.cc/decolua/axonrouter)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Um fork TypeScript completo do AxonRouter. Adiciona mais de 36 provedores, fallback automático de 4 camadas, APIs multimodais (imagens, incorporações, áudio, TTS), disjuntor, cache semântico, avaliações LLM e um painel sofisticado. Mais de 368 testes de unidade. Disponível via npm e Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O AxonRouter porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. AxonRouter adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. AxonRouter injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do AxonRouter não existiriam. Dê uma ⭐ a eles no GitHub!
