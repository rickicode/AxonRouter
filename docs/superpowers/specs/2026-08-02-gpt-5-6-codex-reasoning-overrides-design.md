...
The same matrix applies to axonrouter's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside axonrouter;
  axonrouter only forwards the catalog-advertised reasoning override.
