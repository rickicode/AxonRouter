...
Deploy AxonRouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.axonrouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/axonrouter`:
