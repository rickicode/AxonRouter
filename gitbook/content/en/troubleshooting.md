...
Common issues and solutions when using AxonRouter.
...
1. **Auto-refresh (default):**
   AxonRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
**Problem:** "ECONNREFUSED" or "Cannot connect to localhost:3778".

**Causes:**
- AxonRouter not running
- Port 3778 blocked
...
4. **Use cloud endpoint:**
   ...
   ```
   Endpoint: https://axonrouter.com/v1
   ```
...
1. **Check if AxonRouter is running:**
   ```bash
   # Check process
