...
Get AxonRouter running in 5 minutes and start routing AI requests intelligently.
...
🎉 **Dashboard opens automatically** at `http://localhost:3778`
...
Point your coding tool to AxonRouter:
