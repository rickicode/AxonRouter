...
Common questions about AxonRouter.

---

## What is AxonRouter?

**AxonRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**AxonRouter uses a 3-tier pricing strategy:**
...
**Yes, AxonRouter itself is 100% free and open source.**
...
**Yes! This is AxonRouter's core feature.**
...
**AxonRouter tracks quota in real-time for all providers:**
...
## Can I self-host AxonRouter?

**Yes! AxonRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.axonrouter`)
...
**Yes, AxonRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.axonrouter` (or custom `DATA_DIR`)
- No data sent to AxonRouter servers
...
**What AxonRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What AxonRouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/rickicode/AxonRouter/blob/main/CHANGELOG.md)
- Backup `~/.axonrouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/rickicode/AxonRouter/blob/main/CONTRIBUTING.md) for details.
