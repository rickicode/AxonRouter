...
Integrate AxonRouter with OpenAI Codex CLI to route your OpenAI API requests through AxonRouter's intelligent routing system.
...
AxonRouter provides the following Codex models:
...
1. Verify your API key is correct in AxonRouter dashboard
...
2. Check that the OpenAI provider connection is active in AxonRouter dashboard
