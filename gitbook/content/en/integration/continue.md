...
Integrate AxonRouter with Continue extension to bring AI assistance directly into Visual Studio Code.
...
### 2. Add AxonRouter Model Configuration
...
3. Choose your preferred AxonRouter model
...
- Check network latency to AxonRouter
