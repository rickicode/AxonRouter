...
AxonRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

AxonRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to AxonRouter using these settings:

**Local AxonRouter:**
```
Base URL: http://localhost:3778/v1
API Key: your-api-key-from-dashboard
Model: any AxonRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to AxonRouter
```bash
# Check if AxonRouter is running
...
**Solution:**
- Verify AxonRouter is running
- Check port 3778 is not blocked
...
- Check available models: `curl http://localhost:3778/v1/models`
...
- Check network connection to AxonRouter
