...
Integrate AxonRouter with Claude Code CLI to route your Anthropic API requests through AxonRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to AxonRouter models:
...
1. Verify the model name matches your AxonRouter configuration
...
Make sure you have configured your API key in the AxonRouter cloud dashboard.
