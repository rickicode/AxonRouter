...
Preguntas comunes sobre AxonRouter.

---

## ¿Qué es AxonRouter?

**AxonRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**AxonRouter usa una estrategia de precios de 3 niveles:**
...
## ¿AxonRouter es gratis?

**Sí, AxonRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de AxonRouter.**
...
**AxonRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar AxonRouter?

**¡Sí! AxonRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.axonrouter`)
...
**Sí, AxonRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.axonrouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de AxonRouter
