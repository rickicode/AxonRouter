...
Integra AxonRouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de AxonRouter.
...
export ANTHROPIC_BASE_URL="http://localhost:3778/v1"
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de AxonRouter:
...
```bash
export ANTHROPIC_BASE_URL="https://axonrouter.com"
```
