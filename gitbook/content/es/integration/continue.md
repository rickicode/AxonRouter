...
Integra AxonRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.
...
### 2. Agregar configuración de modelo de AxonRouter
...
3. Elige tu modelo preferido de AxonRouter
...
- Selecciona el modelo correcto de AxonRouter
...
- Verifica la latencia de red hacia AxonRouter
