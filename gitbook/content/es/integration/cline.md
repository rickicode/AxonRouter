...
Integra AxonRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de AxonRouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- AxonRouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de AxonRouter:
...
**Para AxonRouter en la nube:**
```
https://axonrouter.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de AxonRouter
...
3. La key debe comenzar con `sk-axonrouter-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de AxonRouter
...
4. Cline usará AxonRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando AxonRouter
...
3. Obtén explicaciones potenciadas por IA a través de AxonRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará AxonRouter para entender el contexto y hacer cambios
...
1. Verifica que AxonRouter esté corriendo: `curl http://localhost:3778/health`
2. Verifica que la URL base sea correcta e incluya `/v1`
3. Asegúrate de que ningún firewall esté bloqueando el puerto 3778
...
2. Verifica que tu instancia de AxonRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de AxonRouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de AxonRouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://axonrouter.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de AxonRouter
...
## Integración con características de AxonRouter

### Enrutamiento de modelos

AxonRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, AxonRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de AxonRouter:
