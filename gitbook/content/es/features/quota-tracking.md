...
AxonRouter proporciona un seguimiento de cuota integral para todos los proveedores:
...
```bash
GET http://localhost:3778/api/quota
...
```bash
GET http://localhost:3778/api/usage?period=today
Authorization: Bearer your-api-key
...
4. Reinicia AxonRouter si el problema persiste
