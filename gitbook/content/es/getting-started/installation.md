...
Guía detallada de instalación de AxonRouter con consejos de solución de problemas.
...
Instala AxonRouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `axonrouter`
- ✅ Auto-actualizaciones con `npm update -g axonrouter`
...
**Ubicación por defecto:** `~/.axonrouter`
...
**Problema:** AxonRouter usa demasiada RAM
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con axonrouter
```
