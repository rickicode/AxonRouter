...
Ejecuta AxonRouter en tu máquina local para desarrollo y uso personal.

---

## 📦 Instalación

Instala AxonRouter globalmente vía npm:
...
Inicia AxonRouter con un solo comando:
...
- **API Endpoint**: `http://localhost:3778/v1`
- **Directorio de datos**: `~/.axonrouter`
...
El puerto de API (3778) y el puerto del dashboard (3000) están configurados en la aplicación. Para cambiarlos, necesitarás modificar el código fuente o usar variables de entorno si se soportan.

---

## 🛑 Detener el servidor

Presiona `Ctrl+C` en la terminal donde AxonRouter se está ejecutando.

```bash
# En la terminal ejecutando axonrouter
^C  # Presiona Ctrl+C
```
...
Si el puerto 3778 o 3000 ya está en uso:
