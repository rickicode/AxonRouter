...
将 AxonRouter 与 Claude Code CLI 集成,通过 AxonRouter 的智能路由系统转发你的 Anthropic API 请求。
...
Claude Code 支持以下模型别名,映射到 AxonRouter 模型:
...
确保已在 AxonRouter 云端仪表盘中配置 API key。
