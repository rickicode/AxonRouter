...
将 AxonRouter 与 Roo AI 助手集成,通过统一界面访问多个 AI 模型。

## 前置要求

- 已安装 Roo AI 助手
- 来自 [仪表盘](https://axonrouter.com/dashboard) 的 AxonRouter API key
- AxonRouter 正在运行(本地或云端)
...
### 模型不可用
- 检查模型名是否完全匹配(大小写敏感)
- 确认 AxonRouter 套餐中已启用该模型
- 尝试列表中的其他模型

### 响应缓慢
- 切换到更快的模型(haiku、flash)
- 检查网络连接
- 查看 AxonRouter 日志排查问题
