...
Triển khai AxonRouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.axonrouter` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/axonrouter`:
...
# If NOT using reverse proxy, allow AxonRouter ports
