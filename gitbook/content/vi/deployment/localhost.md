...
Chạy AxonRouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt AxonRouter toàn cục qua npm:
...
Khởi động AxonRouter với một lệnh duy nhất:
...
Port API (3778) và port dashboard (3000) được cấu hình trong application. Để đổi, bạn cần sửa source code hoặc dùng biến môi trường nếu được hỗ trợ.

---

## 🛑 Dừng Server

Nhấn `Ctrl+C` trong terminal đang chạy AxonRouter.
...
Nếu port 3778 hoặc 3000 đã được dùng:
