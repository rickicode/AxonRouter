...
Các vấn đề và giải pháp phổ biến khi dùng AxonRouter.
...
1. **Auto-refresh (mặc định):**
   AxonRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra AxonRouter có chạy không:**
   ```bash
   # Check process
