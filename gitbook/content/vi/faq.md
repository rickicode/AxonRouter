...
Những câu hỏi phổ biến về AxonRouter.

---

## AxonRouter là gì?

**AxonRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**AxonRouter dùng chiến lược pricing 3 tầng:**
...
## AxonRouter có miễn phí không?

**Có, AxonRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của AxonRouter.**
...
**AxonRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## AxonRouter có hoạt động với Cursor không?

**Có, nhưng Cursor yêu cầu endpoint cloud.**

**Vấn đề:** Cursor IDE không hỗ trợ endpoint localhost.

**Giải pháp:** Dùng AxonRouter cloud deployment:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://axonrouter.com/v1
...
## Tôi có thể self-host AxonRouter không?

**Có! AxonRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.axonrouter`)
...
**Có, AxonRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.axonrouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server AxonRouter
...
## Làm thế nào để cập nhật AxonRouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/rickicode/AxonRouter/blob/main/CHANGELOG.md)
- Backup `~/.axonrouter` trước khi update lớn
...
3. **Submit code:**
   ```bash
   # Fork repo
   git clone https://github.com/YOUR_USERNAME/axonrouter.git
   cd axonrouter
...
Xem [CONTRIBUTING.md](https://github.com/rickicode/AxonRouter/blob/main/CONTRIBUTING.md) để biết chi tiết.
