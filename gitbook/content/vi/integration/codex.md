...
Tích hợp AxonRouter với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của AxonRouter.
...
AxonRouter cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong AxonRouter dashboard
...
1. Xác minh tên model khớp với cấu hình AxonRouter
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong AxonRouter dashboard
...
Đảm bảo bạn đã cấu hình API key trong AxonRouter cloud dashboard.
