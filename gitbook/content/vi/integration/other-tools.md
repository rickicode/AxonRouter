...
AxonRouter tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

AxonRouter cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến AxonRouter bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến AxonRouter
```bash
...
**Giải pháp:**
- Xác minh AxonRouter đang chạy
- Kiểm tra port 3778 không bị chặn
...
- Kiểm tra model có sẵn: `curl http://localhost:3778/v1/models`
...
- Kiểm tra kết nối network đến AxonRouter
