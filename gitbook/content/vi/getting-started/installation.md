...
Hướng dẫn cài đặt chi tiết cho AxonRouter với mẹo troubleshooting.
...
Cài AxonRouter toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g axonrouter
```

**Khởi động AxonRouter:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `axonrouter`
- ✅ Auto-update với `npm update -g axonrouter`
...
**Vấn đề:** AxonRouter dùng quá nhiều RAM
