...
トラブルシューティングのヒント付きのAxonRouter詳細インストールガイド。
...
どこからでも使用できるようにAxonRouterをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `axonrouter`
- ✅ `npm update -g axonrouter` で自動更新
