...
AxonRouterをOpenAI Codex CLIと統合し、OpenAI APIリクエストをAxonRouterのインテリジェントルーティングシステム経由でルーティングします。
...
1. AxonRouterダッシュボードでAPIキーが正しいか確認
...
1. モデル名がAxonRouter設定と一致するか確認
2. AxonRouterダッシュボードでOpenAIプロバイダー接続がアクティブか確認
